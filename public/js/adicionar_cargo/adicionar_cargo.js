...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //     const resposta = await enviar(`${BASE_URL}/api/cargo/criar_cargo.php`, {cbo: cbo, nomeCargo: nomeCargo, salario: salario, cargaHoraria: cargaHoraria,
    //         regime: regime});
    ...
    btnSalvar.addEventListener("click", async (e) => {
        ...
        const resposta = await enviar(`${BASE_URL}/api/cargo/update_cargo.php`, {
            cbo: cbo,
            nomeCargo: nomeCargo,
            salario: salario,
