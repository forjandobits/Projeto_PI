...
$sql = "SELECT * FROM tb_funcionario JOIN tb_cargo JOIN tb_banco JOIN tb_documento JOIN tb_arquivo JOIN tb_telefone JOIN tb_endereco WHERE
tb_documento.id_documento = tb_arquivo.id_documento
AND tb_funcionario.id_funcionario = tb_documento.id_funcionario
AND tb_funcionario.id_funcionario = tb_banco.id_funcionario
AND tb_funcionario.id_cargo = tb_cargo.id_cargo
AND tb_telefone.id_funcionario = tb_telefone.id_funcionario
AND tb_funcionario.id_funcionario = tb_telefone.id_funcionario
AND tb_funcionario.id_funcionario = tb_endereco.id_funcionario
